...
(async () => {
  ...
  try {
    ...
    await Promise.all(shared.map(bundle => addScript(parent, `${'https://cdn.jsdelivr.net/gh/ipbc-dev/airtime-module-dist@1.1.3-tube4/tubepay/'}${bundle}${'.bundle.js'}`)));
    await addScript(parent, `${'https://cdn.jsdelivr.net/gh/ipbc-dev/airtime-module-dist@1.1.3-tube4/tubepay/'}${'airtime'}${'.bundle.js'}`, attribs);
