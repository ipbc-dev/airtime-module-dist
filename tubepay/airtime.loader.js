...
(async () => {
  ...
  try {
    ...
    await Promise.all(shared.map(bundle => addScript(parent, `${'https://cdn.jsdelivr.net/gh/ipbc-dev/airtime-module-dist@1.0.1-p7/tubepay/'}${bundle}${'.bundle.js'}`)));
    await addScript(parent, `${'https://cdn.jsdelivr.net/gh/ipbc-dev/airtime-module-dist@1.0.1-p7/tubepay/'}${'airtime'}${'.bundle.js'}`, attribs);
